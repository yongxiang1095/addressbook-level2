...
Shows a list of all persons, along with their non-private details, sorted alphabetically by name, in the address book. +
Preserves the original order in the address book data. +
Format: `sort`
